...
import { Map as LeafletMap, TileLayer, Marker, Popup, ZoomControl, GeoJSON } from "react-leaflet";
...
const MAPBOX_ACCESS_TOKEN = "pk.eyJ1Ijoia2lyZG9udHNvdiIsImEiOiJjazZjNnZka2EwODJjM29xeDdscHcwYnAyIn0.jR6sL1P44Vjaybu-Ty2hdg";
		...
		return (
			<Fragment>
				<LeafletMap center={position} zoom={zoom} zoomControl={false} maxZoom={20} minZoom={4}>
					...
					<MapboxLayer accessToken={MAPBOX_ACCESS_TOKEN} style="mapbox://styles/kirdontsov/ck6cbhtnf27vu1inwoo33gdcx" />
